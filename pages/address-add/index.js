...
Page({
  ...
  bindSave: function(e) {
    ...
    wx.request({
      url: app.globalData.api + app.globalData.subDomain + '/user/shipping-address/' + apiAddoRuPDATE,
      data: {
  ...
  onLoad: function (e) {
    ...
    if (id) {
      ...
      wx.showLoading();
      wx.request({
        url: app.globalData.api + app.globalData.subDomain + '/user/shipping-address/detail',
        data: {
          token: app.globalData.token,
          id: id
        },
  ...
  deleteAddress: function (e) {
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          wx.request({
            url: app.globalData.api + app.globalData.subDomain + '/user/shipping-address/delete',
            data: {
              token: app.globalData.token,
              id: id
            },
