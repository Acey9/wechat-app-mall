...
Page({
    ...
    onShow : function () {
      var that = this;
      wx.request({
        url: app.globalData.api + app.globalData.subDomain + '/order/detail',
        data: {
      ...
      wx.showModal({
          ...
          success: function(res) {
            if (res.confirm) {
              wx.showLoading();
              wx.request({
                url: app.globalData.api + app.globalData.subDomain + '/order/delivery',
                data: {
                  token: app.globalData.token,
                  orderId: orderId
                },
    ...
    submitReputation: function (e) {
      ...
      wx.showLoading();
      wx.request({
        url: app.globalData.api + app.globalData.subDomain + '/order/reputation',
        data: {
